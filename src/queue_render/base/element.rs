use crate::{
    component::{
        queue_render::{QueueRender, Value, ValueContent, MapValue},
        Comp, Component,
    },
    dom::{ElementStatus,QrBoolAttribute, QrNormalAttribute, QrBoolAttributeMap, QrNormalAttributeMap, WsElement},
...
impl<'a, C: Component> ElementRender<'a, C> {
    ...
    {
        self.qa_map(name, value, QrBoolAttribute::new, QrBoolAttributeMap::new, |q, u|{
            q.update(u);
        });
    }
    ...
    {
        self.qa_map(name, value, QrNormalAttribute::new, QrNormalAttributeMap::new, |q, u|{
